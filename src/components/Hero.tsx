...
// Import Three.js background only for large screens
...
const Hero = () => {
  ...
  return (
    ...
    >
      {/* Only show ThreeBackground on larger screens */}
      {typeof window !== 'undefined' && window.innerWidth >= 1024 && <ThreeBackground />}
      ...
      <div className="absolute inset-0 -z-10 pointer-events-none">
        ...
        />
        <motion.div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-primary/10 rounded-full blur-2xl"
