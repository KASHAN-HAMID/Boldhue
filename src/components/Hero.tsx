  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      if (window.innerWidth >= 1024) {
        ...
        import('./ThreeBackgroundLite').then((mod) => {
          setThreeBackground(() => mod.default);
        });
      }
    }
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <motion.h1
          className="text-5xl md:text-6xl lg:text-7xl font-bold mb-8 bg-gradient-to-r from-foreground via-primary to-foreground bg-clip-text text-transparent animate-gradient font-poppins"
        ...
        >
          We create bold, innovative digital experiences that elevate your brand and captivate your audience.
        </motion.p>
